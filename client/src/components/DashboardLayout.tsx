...
import { LayoutDashboard, LogOut, PanelLeft, Target, Plus, Building2, FileText, CalendarDays, Settings2, CheckSquare, Repeat, Bot, ScrollText, Megaphone, Rocket, Images, Users, Brain, FolderGit2, ClipboardSignature, Server } from "lucide-react";
...
const menuGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: ClipboardSignature, label: "Quotes", path: "/quotes" },
    ],
  },
  {
    label: "Creative",
              ...
              {!isCollapsed ? (
                <>
                  <div className="flex items-center gap-2 min-w-0 flex-1">
                    <img src="https://pub-7689bb2e0fe5474fb166518d32366c41.r2.dev/media/1773557375019-ei1drt50gii.png" alt="GRO Digital" className="h-7 w-auto object-contain" />
                  </div>
                  <div className="flex items-center gap-1 shrink-0">
                    <TaskTray />
                    <Link href="/invoice/new">
                      <button
                        className="h-7 w-7 flex items-center justify-center hover:bg-accent rounded-lg transition-colors focus:outline-none"
                        title="New Invoice"
                      >
